...
static GL4_Vertex_Format gen_pos_3f_format(){
    GL4_Vertex_Format vertex(_GL4_Vertex_Feed_ID::pos_3f, 3, sizeof(GLfloat), GL_FLOAT, GL_FALSE, _vaoPtrModes::Default, _GL4_Shader_Format_ID::vec3);
    return vertex;
}

static GL4_Vertex_Format gen_pos_2f_format(){
    GL4_Vertex_Format vertex(_GL4_Vertex_Feed_ID::pos_2f, 2, sizeof(GLfloat), GL_FLOAT, GL_FALSE, _vaoPtrModes::Default, _GL4_Shader_Format_ID::vec3);
    return vertex;
}

static GL4_Vertex_Format gen_color_4f_format(){
    GL4_Vertex_Format vertex(_GL4_Vertex_Feed_ID::color_4f, 4, sizeof(GLubyte), GL_UNSIGNED_BYTE, GL_TRUE, _vaoPtrModes::Default, _GL4_Shader_Format_ID::vec4);
    return vertex;
}

static GL4_Vertex_Format gen_normal_3f_format(){
    GL4_Vertex_Format vertex(_GL4_Vertex_Feed_ID::normal_3f, 3, sizeof(GLfloat), GL_FLOAT, GL_FALSE, _vaoPtrModes::Default, _GL4_Shader_Format_ID::vec3);
    return vertex;
}

static GL4_Vertex_Format gen_texCoord_2f_format(){
    GL4_Vertex_Format vertex(_GL4_Vertex_Feed_ID::texCoord_2f, 2, sizeof(GLfloat), GL_FLOAT, GL_FALSE, _vaoPtrModes::Default, _GL4_Shader_Format_ID::vec2);
    return vertex;
}

static GL4_Vertex_Format gen_frag_4f_format(){
    GL4_Vertex_Format vertex(_GL4_Vertex_Feed_ID::frag_4f, 4, sizeof(GLfloat), GL_FLOAT, GL_FALSE, _vaoPtrModes::Default, _GL4_Shader_Format_ID::vec4);
    return vertex;
}
