...
int main(int argc, const char* argv[]){
    ...
    Vertex verts3[] = {
        { {0.7f, 0.7f, 0}, {63, 127, 191, 255} }, // INDEX 0
        { {0.7f, -0.7f, 0}, {219, 97, 99, 255} }, // INDEX 1
        { {-0.7f, 0.7f, 0}, {126, 251, 138, 255} }, // INDEX 2
        { {-0.7f, -0.7f, 0}, {181, 127, 98, 255} }, // INDEX 3

        { {0.5f, 0.5f, 0}, {63, 127, 191, 255} }, // INDEX 4
        { {0.5f, -0.5f, 0}, {219, 97, 99, 255} }, // INDEX 5
        { {-0.5f, 0.5f, 0}, {126, 251, 138, 255} }, // INDEX 6
        { {-0.5f, -0.5f, 0}, {181, 127, 98, 255} }, // INDEX 7

        { {0.3f, 0.3f, 0}, {63, 127, 191, 255} }, // INDEX 8
        { {0.3f, -0.3f, 0}, {219, 97, 99, 255} }, // INDEX 9
        { {-0.3f, 0.3f, 0}, {126, 251, 138, 255} }, // INDEX 10
        { {-0.3f, -0.3f, 0}, {181, 127, 98, 255} }, // INDEX 11
    };
