...
void keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods){
    ...
    std::cout << "scaleX: " << scaleX << " scaleY: " << scaleY << " moveX: " << moveX << " moveY: " << moveY << " timeAngle: " << timeAngle
...
int main(int argc, const char* argv[]){
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // LookMatrix = glm::lookAt(glm::vec3(0.0, 0.0, 3.0f), glm::vec3(0.0, 0.0, 0.0f), glm::vec3(0.0, 1.0, 3.0f));
