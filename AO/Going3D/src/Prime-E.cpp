...
int main(int argc, char** argv){
    ...
    GLint simpleDiffuseGLSL_Projection = glGetUniformLocation(simpleDiffuseGLSL, "Projection");
    GLint simpleDiffuseGLSL_View = glGetUniformLocation(simpleDiffuseGLSL, "View");
    GLint simpleDiffuseGLSL_Model = glGetUniformLocation(simpleDiffuseGLSL, "Model");
    ...
    cube1_Origin = glm::vec3(4.0f, -10.0f, -10.0f);
    ...
    GLfloat ambientLightStrength = 0.8f;
    GLfloat worldLightColor[3] = { 1.0f, 1.0f, 1.0f };
    GLfloat lightSourcePos[3] = { 0, 100.0f, 0 };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniformMatrix4fv(simpleDiffuseGLSL_Projection, 1, GL_FALSE, glm::value_ptr(projectionMatrix));
		glUniformMatrix4fv(simpleDiffuseGLSL_View, 1, GL_FALSE, glm::value_ptr(viewMatrix));
        ...
        glBindVertexArray(VAOs[0]);
        glUniformMatrix4fv(simpleDiffuseGLSL_Model, 1, GL_FALSE, glm::value_ptr(cube1_Matrix));
